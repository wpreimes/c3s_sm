...
def test_C3STs_tcdr_combined_daily():
    ...
    ds = C3SImg(file, mode='r', parameters='sm', flatten=False)
    image= ds.read()
...
def test_1Dreading():
    ...
    ds = C3SImg(file, mode='r', parameters='sm', flatten=True)
    image = ds.read()
    ...
    ds = C3SImg(file, mode='r', parameters='sm', flatten=True, grid=land_grid)
    image = ds.read()
...
if __name__ == '__main__':
    test_1Dreading()
    test_C3STs_icdr_active_monthly()
    test_C3STs_icdr_combined_daily()
    test_C3STs_icdr_passive_decadal()
    test_C3STs_tcdr_active_monthly()
    test_C3STs_tcdr_combined_daily()
    test_C3STs_tcdr_passive_decadal()
